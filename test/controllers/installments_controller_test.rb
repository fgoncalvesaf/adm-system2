...
class InstallmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create installment" do
    assert_difference('Installment.count') do
      post installments_url, params: { installment: { payment_date: @installment.payment_date, sale_id: @installment.sale_id, value: @installment.value } }
    end
  ...
  test "should update installment" do
    patch installment_url(@installment), params: { installment: { payment_date: @installment.payment_date, sale_id: @installment.sale_id, value: @installment.value } }
